<?php
 ...
 if(!$conn)
 {
  ...
  if($_SERVER['REQUEST_METHOD']=='POST')
  {
    ...
    $sql="UPDATE `patient` SET `Pfname` = '$Pfname', `Plname` = '$Plname', `Gender` = '$Gender', `Admission_date` = '$Admission_date', `Admission_id` = '$Admission_id' WHERE `patient`.`Patient_id` = '$Patient_id'";
...
<div>
<h1 align='center'>UPDATE PATIENT DETAILS</h1><br>
